...
def test_search_scholarships_authenticated(internal_token_header):
...
def test_search_scholarships_with_student_profile(internal_token_header):
...
def test_get_scholarship_not_found(internal_token_header):
...
def test_get_scholarships_by_program(internal_token_header):
